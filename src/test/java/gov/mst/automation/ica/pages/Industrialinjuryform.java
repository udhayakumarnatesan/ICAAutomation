...
public class Industrialinjuryform {
	...
	public static void Industrialinjurywebform(WebDriver driver, String tcname) throws Exception {
		...
		form.employeelastname.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee Last Name"));
		form.employeefirstname.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee First Name"));
		form.employeesocialsecuritynumber.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee Social Security Number"));
		form.employeebirthdate.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee Birth Date"));
		form.employeehomeaddress.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee Home Address"));
		form.employeecity.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee City"));
		form.employeestate.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee State"));
		form.employeezipcode.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee Zipcode"));
		form.employeetelephone.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employee Telephone"));
		form.employeesex(driver);
		form.employeemaritalstatus(driver);
		form.employername.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer Name"));
		form.employerfeinnumber.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer Fein Number"));
		form.employerofficeaddress.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer Office Address"));
		form.employercity.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer City"));
		form.employerstate.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer State"));
		form.employerzipcode.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer Zipcode"));
		form.employertelephone.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "Employer Telephone"));
		form.addateofinjury.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD Date of Injury"));
		form.addateemployernotified.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD Date Employer Notified of Injury"));
		form.adlastdateofworkafterinjury.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD Last Date of Work After Injury"));
		form.adhasemployeereturnedtowork.click();
		form.ademployeeoccupation.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD Employee Occupation"));
		form.addidinjuryoccur(driver);
		form.adwhatwastheinjury.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD What was the Injury"));
		form.adpartofbodyinjured.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD Part of the Body Injured"));
		form.adpartofbodyinjurytable.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AD Part of the Body Injury Table"));
		form.adfatal(driver);
		...
		form.coawhathappened.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "COA What happened"));
		form.coawhatobject.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "COA What object"));
		form.coanatureofinjury.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "COA Nature of Injury"));
		form.coacauseofinjury.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "COA Cause of Injury"));
		form.coawhatwasemployeedoing.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "COA What was the Employee Doing Just Before the Incidient"));
		form.coawasworkerinyouremploy(driver);
		form.coadateoflasthire.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "COA Date of Last Hire"));
		form.ewdactualgrossearnings.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "EWD Actual Gross Earnings of Employee"));
		form.assubmitteremail.sendKeys(gov.mst.automation.ica.excelutility.Readexcel.readData(tcname, "AS Submitter Email Address"));
		form.iagree.click();
		form.submit.click();
	}											
